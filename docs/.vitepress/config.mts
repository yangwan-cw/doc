...
const vitePressSidebarOptions = {
  documentRootPath: '/docs',    // Root path for the document
  collapsed: false,          // Default state of the sidebar (expanded)
  capitalizeFirst: true      // Capitalize the first letter of section titles
}
...
export default withMermaid(withSidebar(vitePressConfig, vitePressSidebarOptions));
